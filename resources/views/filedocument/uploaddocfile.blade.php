                ...
                <div class="card-body">
                    <form action="/filedoc/upload" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>หมวดหมู่</label>
                                <select class="form-control select2" style="width: 100%;" name="subcate_id" id="sub_category"
                                    required>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="file" class="form-control" autocomplete="off" name="filepath" required>
                                </div>
